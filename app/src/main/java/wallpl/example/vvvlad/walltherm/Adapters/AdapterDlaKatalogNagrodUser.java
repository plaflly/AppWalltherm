...
import wallpl.example.vvvlad.walltherm.NagrodaDlaUser;
...
public class AdapterDlaKatalogNagrodUser  extends RecyclerView.Adapter<AdapterDlaKatalogNagrodUser.MyViewHolder>{
    private Context context;
    private ArrayList<Nagroda> nagrody;

    public AdapterDlaKatalogNagrodUser(Context c, ArrayList<Nagroda> m) {
        context = c;
        nagrody = m;
    }
    ...
    @NonNull
    @Override
    public AdapterDlaKatalogNagrodUser.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.for_recycler_katalog_nagrod, viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterDlaKatalogNagrodUser.MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.layoutRecyclernagrod.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, NagrodaDlaUser.class);
