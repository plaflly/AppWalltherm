...
public class SklepForAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sklep_for_admin);
        listView = findViewById(R.id.lvExp);
        Intent intent = getIntent();
        format = intent.getStringExtra("format");
        button = findViewById(R.id.sklepAdminButton);
        ...
        if (isOnline()) {
            ...
            Snackbar.make(findViewById(R.id.sklepForAdmin), "Internet niedostępny!", Snackbar.LENGTH_LONG).show();
    ...
    private void sRec(String status) {
        if (status.equals("connected")) {
            if (!connect) {
                Snackbar.make(findViewById(R.id.sklepForAdmin), "Internet dostępny!", Snackbar.LENGTH_LONG).show();
                connect = true;
            }
    ...
    private void addSklep(String format) {
        Intent intent1 = new Intent(this, AddSklep.class);
        intent1.putExtra("hurtownia", format);
