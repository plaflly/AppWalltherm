...
public class ListKatalogAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_katalog_admin);
        listview = findViewById(R.id.listCatalogsAdmin);
        ...
        if (isOnline()) {
            ...
            Snackbar.make(findViewById(R.id.listKatalogAdmin), "Internet niedostępny!", Snackbar.LENGTH_LONG).show();
    ...
    private void sRec(String status) {
        if (status.equals("connected")) {
            if (!connect) {
                Snackbar.make(findViewById(R.id.listKatalogAdmin), "Internet dostępny!", Snackbar.LENGTH_LONG).show();
                connect = true;
            }
